...
namespace Benchmarker.Benchmarks
{
    public class StreamsComparerBenchmark
    {
        ...
        public bool Linq()
        {
            var equal = Equal_Linq(XStream!, YStream!, out _);
            return equal == EqualMethodResult.ComparedEqual;
        }
        ...
        {
            var equal = Equal_Vector(XStream!, YStream!, out _);
            return equal == EqualMethodResult.ComparedEqual;
        }
        ...
        public static EqualMethodResult Equal_Linq(Stream xStream, Stream yStream, out long? failurePoint)
        {
            failurePoint = null;
            bool bothSeekable = xStream.CanSeek && yStream.CanSeek;
        ...
        public static EqualMethodResult Equal_Vector(Stream xStream, Stream yStream, out long? failurePoint)
        {
            failurePoint = null;
            bool bothSeekable = xStream.CanSeek && yStream.CanSeek;
